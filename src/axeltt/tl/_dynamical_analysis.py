...
def dynamical_analysis(sc_object: AnnData,
                       sc_object_aggr: AnnData, 
                       n_states: int = None,
                       n_states_seq: int = None,
...
def dynamical_iteration(adata: AnnData, 
                        n_states: int = None, 
                        n_states_seq: list = None,
                        n_iter: int = 10, 
                        return_aggr_obj: bool = True, 
                        weight_connectivities: float = 0.2, 
                        n_components: int = 20, 
                        n_neighbors: int = 100,
    ...
    sc_object_aggr = AnnData(X=X_all)
